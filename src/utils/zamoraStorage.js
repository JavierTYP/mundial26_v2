const KEY_PREFIX = "mundial2026_zamora_v1:";
...
function normalizePick(pick) {
  ...
  return {
    ...
    goalkeeper: typeof row?.goalkeeper === "string" ? row.goalkeeper : "",
  };
}

export function loadZamora(email) {
  try {
...
export function saveZamora(email, pick) {
